...
const SoftwareServiceImages = () => {
  ...
  <div className="absolute inset-0 pointer-events-none opacity-[0.18]">
    <div className="absolute top-12 left-20 w-36 h-36 rounded-full bg-gradient-to-br from-orange-400/40 to-red-500/40 blur-3xl" />
    <div className="absolute bottom-16 right-24 w-40 h-40 rounded-full bg-gradient-to-br from-pink-400/40 to-orange-500/40 blur-3xl" />
  </div>
...
{/* </section> */}
     <section className="relative h-screen w-full overflow-hidden flex items-center bg-gray-900 text-white">
...
<span
  onClick={goToHome2}
  className="font-semibold text-orange-400 cursor-pointer hover:underline"
>
  Maxzen.Tech
</span>,

 we are a results-driven software development company in Hyderabad. We specialize in building innovative, scalable, and cost-effective digital solutions that empower startups, mid-sized businesses, and enterprises to succeed.
      </p>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
      {[
        ...
        <motion.div
          ...
          className="bg-white shadow-lg rounded-2xl p-6 flex items-start gap-4 hover:shadow-2xl transition-transform duration-300"
        >
      ...
      >
        <motion.img
          ...
          animate={{
            ...
            filter: hoveredIndex === i ? "brightness(0.82)" : "brightness(1)",
          }}
...
<section className="relative py-2 mt-2 overflow-hidden bg-gradient-to-br from-gray-50 via-white to-orange-50">
  <div className="absolute inset-0 bg-gradient-to-r to-pink-200 opacity-30 blur-3xl" />
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
      {[
        ...
        <motion.div
          ...
          className="relative bg-white/30 backdrop-blur-lg border border-white/60 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500"
        >
...
<section className="relative py-2 mt-12 overflow-hidden bg-gradient-to-br from-white via-orange-50 to-orange-100">
  <div className="absolute inset-0 bg-gradient-to-r from-orange-200 via-red-200 to-pink-200 opacity-30 blur-3xl" />
