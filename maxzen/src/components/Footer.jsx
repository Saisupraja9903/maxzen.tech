...
import { ArrowRight, MessageCircleQuestion, BookOpen, TrendingUp, Mail } from "lucide-react";
          ...
          >
            ...
            <div>
              ...
              <div className="flex justify-start gap-4">
                <a href="https://www.facebook.com/people/MaxzenTech/61574235826967/" target="_blank" rel="noopener noreferrer" className="p-3 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-600 hover:text-white transition-all">
                  <FaFacebookF />
                </a>
                <a href="https://x.com/maxzen_tech" target="_blank" rel="noopener noreferrer" className="p-3 bg-sky-100 text-sky-600 rounded-full hover:bg-sky-500 hover:text-white transition-all">
                  <FaTwitter />
                </a>
                <a href="https://www.linkedin.com/company/maxzen-tech/" target="_blank" rel="noopener noreferrer" className="p-3 bg-indigo-100 text-indigo-600 rounded-full hover:bg-indigo-600 hover:text-white transition-all">
                  <FaLinkedinIn />
                </a>
                <a href="https://www.instagram.com/maxzen.tech/?hl=en" target="_blank" rel="noopener noreferrer" className="p-3 bg-pink-100 text-pink-600 rounded-full hover:bg-pink-600 hover:text-white transition-all">
                  <FaInstagram />
                </a>
                 <a href="https://www.youtube.com/@maxzentech" target="_blank" rel="noopener noreferrer" className="p-3 bg-red-100 text-red-600 rounded-full hover:bg-red-600 hover:text-white transition-all">
                  <FaYoutube />
                </a>
              </div>
            </div>
            ...
            {/* Newsletter */}
            <div>
              <h3 className="text-xl font-semibold mb-3 text-left">Newsletter</h3>
              <p className="text-gray-600 text-sm mb-4 text-left">Subscribe to get the latest content by email.</p>
              <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                ...
                />
                <button className="p-3 bg-orange-500 text-white hover:bg-orange-600 transition">
            ...
            <div className="bg-gradient-to-br from-blue-500 to-indigo-600 text-white p-6 rounded-2xl text-center">
                ...
                <p className="mb-4 text-blue-100">
                    Ready to grow your business? We offer expert digital marketing solutions tailored for you.
                </p>
                <button 
                  onClick={() => navigate("/contact")}
                  className="bg-white text-blue-600 font-semibold px-6 py-2 rounded-full hover:bg-gray-100 transition-all w-full"
                >
                  Get a Free Quote
                </button>
            </div>
