          ...
          >
            <Link to="/" className="flex items-center gap-3 cursor-pointer">
              ...
              <div className="flex flex-col justify-center leading-tight">
                <span className="text-white font-semibold text-3xl font-sans">
                  Maxzen.Tech
                </span>
              </div>
            </Link>
        ...
        >
          ...
          >
            ...
            <p className="flex items-start justify-center md:justify-start gap-2">
             ...
             4th Floor-408, Manjeera Trinity Corporate, <br /> KPHB, Hyderabad
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="flex items-center justify-center md:justify-start gap-2 mt-2">
              <FaPhoneAlt className="text-red-500" /> +91 8498989844
            </p>
          </motion.div>
